...
-- Note: Non-interactive execution safe: contains zero SQL*Plus substitution
--       variables (no unintended ampersands).
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- 2. USER_CONTACT_NUMBERS (14 Contact Numbers)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 3. ALERT_CATEGORIES (5 Categories)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 5. HOME_ACCESS (14 M:N Records with OWNER and MEMBER roles)
-- ----------------------------------------------------------------------------
-- Home 1 Access (Sanctuary Haven)
...
-- Home 2 Access (Alpine Ridge Retreat)
INSERT INTO HOME_ACCESS (user_id, home_id, role, date_granted)
...
-- Home 3 Access (Coastal Horizon Villa)
INSERT INTO HOME_ACCESS (user_id, home_id, role, date_granted)
...
-- Home 4 Access (Skyline Urban Loft)
INSERT INTO HOME_ACCESS (user_id, home_id, role, date_granted)
...
-- Home 5 Access (Cedar Grove Residence)
INSERT INTO HOME_ACCESS (user_id, home_id, role, date_granted)
...
-- ----------------------------------------------------------------------------
-- 7. DEVICES (45 Devices with Parent/Child Hierarchies)
-- ----------------------------------------------------------------------------
-- Home 1 Devices (Hub: 1)
...
-- Home 2 Devices (Hub: 10)
INSERT INTO DEVICES (device_id, device_name, device_subtype, status, install_date, last_restart_time, room_id, parent_device_id)
VALUES (10, 'Alpine Gateway Hub', 'HUB', 'ONLINE', DATE '2026-02-10', TIMESTAMP '2026-09-01 06:00:00', 4, NULL);

INSERT INTO DEVICES (device_id, device_name, device_subtype, status, install_date, last_restart_time, room_id, parent_device_id)
VALUES (7, 'Great Room Ambient Light', 'SMART_LIGHT', 'OFFLINE', DATE '2026-02-12', TIMESTAMP '2026-08-20 14:00:00', 4, 10);

INSERT INTO DEVICES (device_id, device_name, device_subtype, status, install_date, last_restart_time, room_id, parent_device_id)
VALUES (8, 'Patio Weather Temp Sensor', 'TEMPERATURE_SENSOR', 'ONLINE', DATE '2026-02-15', TIMESTAMP '2026-09-16 09:00:00', 5, 10);
...
-- ----------------------------------------------------------------------------
-- 8. DEVICE SUBTYPES (10 Lights, 5 Thermostats, 10 Temp, 8 Motion, 7 Cameras)
-- ----------------------------------------------------------------------------

-- SMART_LIGHTS (10 Records)
...
-- THERMOSTATS (5 Records, "MODE" Quoted)
...
-- TEMPERATURE_SENSORS (10 Records)
...
-- ----------------------------------------------------------------------------
-- 9. SENSOR_READINGS (120 Time-Series Records across 10 Sensors)
-- ----------------------------------------------------------------------------
-- Device 4: Kitchen Temp Sensor (Readings 1 - 12)
INSERT INTO SENSOR_READINGS (device_id, reading_id, value, reading_time) VALUES (4, 1, 23.40, TIMESTAMP '2026-09-17 08:00:00');
INSERT INTO SENSOR_READINGS (device_id, reading_id, value, reading_time) VALUES (4, 2, 23.80, TIMESTAMP '2026-09-17 09:00:00');
INSERT INTO SENSOR_READINGS (device_id, reading_id, value, reading_time) VALUES (4, 3, 24.10, TIMESTAMP '2026-09-17 10:00:00');
INSERT INTO SENSOR_READINGS (device_id, reading_id, value, reading_time) VALUES (4, 4, 24.50, TIMESTAMP '2026-09-17 11:00:00');
INSERT INTO SENSOR_READINGS (device_id, reading_id, value, reading_time) VALUES (4, 5, 25.20, TIMESTAMP '2026-09-17 12:00:00');
...
-- Device 8: Patio Weather Temp Sensor (Readings 13 - 24)
...
-- Device 14: Basement Water/Temp Sensor (Readings 37 - 48)
...
-- Device 27: Attic Ambient Temp Sensor (Readings 73 - 84)
...
-- Device 33: Chicago Server Room Thermal Sensor (Readings 85 - 96)
...
-- ----------------------------------------------------------------------------
-- 11. RULE_ACTIONS (25 Actions)
-- ----------------------------------------------------------------------------
-- Rule 1 Actions (Kitchen High Temp -> Adjust HVAC and Dim Light)
...
-- Rule 2 Actions (Bedroom Night Security -> Record Entrance Camera)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
VALUES (3, 2, 6, 'RECORD_CLIP', '60S');

-- Rule 3 Actions (Basement Freeze -> Switch Thermostat to Heat)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
VALUES (4, 3, 3, 'SET_MODE', 'HEAT');

-- Rule 4 Actions (Alpine Great Room Motion -> Turn On Light and Heat)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
...
-- Rule 5 Actions (Alpine Freeze -> Capture Snapshot)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
VALUES (7, 5, 9, 'TRIGGER_SNAPSHOT', 'NOW');

-- Rule 6 Actions (Attic Overheat -> Drop Alpine Target Temp)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
VALUES (8, 6, 26, 'SET_TEMP', '18.0');

-- Rule 7 Actions (Poolside Intrusion -> Record Clip and Flash Light Red)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
...
-- Rule 8 Actions (Wine Cellar Temp -> Set HVAC to 12.0C and Log)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
...
-- Rule 9 Actions (Master Suite Motion -> Gentle Reading Light)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
VALUES (12, 9, 22, 'SET_BRIGHTNESS', '25');

-- Rule 10 Actions (Malibu Kitchen Heat -> Cool Mode and Blue Accent)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
...
-- Rule 11 Actions (Chicago Server Thermal -> Cool Temp, Record Clip, Amber Alert)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
...
-- Rule 12 Actions (Chicago Terrace Motion -> Record Balcony and Light Lounge)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
...
-- Rule 13 Actions (Seattle Workshop Intrusion -> Record Driveway and Flash Red)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
...
-- Rule 14 Actions (Seattle Workshop Low Temp -> Boost Thermostat Heat)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
VALUES (21, 14, 39, 'SET_TEMP', '20.0');

-- Rule 15 Actions (Cedar Dining Motion -> Turn On Accent Strip)
INSERT INTO RULE_ACTIONS (action_id, rule_id, target_device_id, action_type, action_value)
VALUES (22, 15, 44, 'SET_BRIGHTNESS', '80');


-- ----------------------------------------------------------------------------
-- 12. ALERTS (35 Alerts covering all 5 categories, acknowledged & active)
-- ----------------------------------------------------------------------------
...
VALUES (1, 4, 2, 1, 'Kitchen ambient temperature exceeded threshold: 26.8C', TIMESTAMP '2026-09-17 13:00:05', 'RULE', 'ACKNOWLEDGED', 1, TIMESTAMP '2026-09-17 13:10:00');

-- Alert 2: Unacknowledged security alert triggered by Rule 2
INSERT INTO ALERTS (alert_id, device_id, category_id, triggered_by_rule_id, message, alert_time, source, status, acknowledged_by, acknowledged_timestamp)
VALUES (2, 5, 1, 2, 'Unscheduled motion detected in Master Bedroom', TIMESTAMP '2026-09-17 21:05:00', 'RULE', 'ACTIVE', NULL, NULL);

-- Alert 3: Unacknowledged hardware maintenance alert (Threshold)
INSERT INTO ALERTS (alert_id, device_id, category_id, triggered_by_rule_id, message, alert_time, source, status, acknowledged_by, acknowledged_timestamp)
VALUES (3, 9, 3, NULL, 'Garden Perimeter Camera offline: storage communication failure', TIMESTAMP '2026-09-17 01:20:00', 'THRESHOLD', 'ACTIVE', NULL, NULL);

-- Alerts 4 - 10: Environmental & Maintenance alerts
INSERT INTO ALERTS (alert_id, device_id, category_id, triggered_by_rule_id, message, alert_time, source, status, acknowledged_by, acknowledged_timestamp)
...
-- Alerts 11 - 20: Security, Health, Energy, and Threshold alerts
INSERT INTO ALERTS (alert_id, device_id, category_id, triggered_by_rule_id, message, alert_time, source, status, acknowledged_by, acknowledged_timestamp)
...
-- Alerts 21 - 35: Multi-home operational telemetry alerts
INSERT INTO ALERTS (alert_id, device_id, category_id, triggered_by_rule_id, message, alert_time, source, status, acknowledged_by, acknowledged_timestamp)
...
-- ----------------------------------------------------------------------------
-- 13. NOTIFICATION_PREFERENCES (25 Ternary Records: User x Device x Category)
-- ----------------------------------------------------------------------------
-- User 1 Preferences
